...
const T = {
  ru: {
    ...
    'hero.name.bold': 'Левашев',
    'hero.role':      'Алексей Левашев · Психолог · Психотравматолог · КПТ-терапевт',
    ...
    'blog3.time':  '8 мин',
    'blog2.exc':   'КПТ: наиболее изученный метод в психотерапии. Объясняю принципы, структуру сессий и почему этот подход меняет жизнь.',
    'blog3.exc':   'Посттравматическое расстройство касается не только войны. Любое событие, которое перегрузило психику, может оставить след.',
    'blog4.title': 'Тревожность и тревога: в чём разница и когда пора обратиться за помощью',
    'blog4.exc':   'Тревога нормальна. Тревожное расстройство уже нет. Разбираю, где проходит граница и какие симптомы говорят о том, что стоит поговорить со специалистом.',
    'blog5.title': 'Выгорание: 7 признаков и первые шаги к восстановлению',
    'blog5.exc':   'Выгорание: не слабость и не лень. Это исчерпание ресурсов. Как отличить его от усталости и как начать возвращаться к себе.',
    'blog6.title': 'Психология и коучинг: что выбрать и чем они отличаются',
    'blog6.exc':   'Оба варианта помогают измениться, но работают с разным. Объясняю принципиальную разницу подходов и кому что подходит.',
    'blog7.title': 'Техники заземления: как успокоиться, когда захлёстывают эмоции',
    'blog7.exc':   'Заземление: набор техник для возвращения в «здесь и сейчас». Работают при тревоге, флэшбэках, диссоциации.',
    'blog8.title': 'Нарушения сна и психика: как разорвать порочный круг',
    'blog8.exc':   'Депрессия нарушает сон, плохой сон усугубляет депрессию. КПТ при инсомнии (КПТ-I): метод, который меняет структуру сна.',
    'blog9.title': 'Когнитивные искажения: 10 ловушек мышления, которые делают нас несчастными',
    ...
    /* Footer */
    'footer.copy':     '© 2025 Алексей Левашев · Психолог',
  ...
  pl: {
    ...
    'blog3.time':  '8 min',
    'blog2.exc':   'CBT: jedna z najlepiej przebadanych form psychoterapii. Wyjaśniam zasady, strukturę sesji i dlaczego ta metoda przynosi konkretne zmiany.',
    'blog3.exc':   'PTSD dotyczy nie tylko wojen. Każde zdarzenie, które przeciążyło psychikę, może zostawić ślad.',
    'blog4.title': 'Lęk i zaburzenie lękowe: jaka jest różnica i kiedy szukać pomocy',
    'blog4.exc':   'Lęk jest normalny. Zaburzenie lękowe już nie. Wyjaśniam, gdzie przebiega granica i jakie objawy wskazują, że warto porozmawiać ze specjalistą.',
    'blog5.title': 'Wypalenie: 7 sygnałów i pierwsze kroki do odbudowy',
    'blog5.exc':   'Wypalenie to nie słabość ani lenistwo. To wyczerpanie zasobów. Jak odróżnić je od zmęczenia i jak zacząć wracać do siebie.',
    'blog6.title': 'Psychologia czy coaching: co wybrać i czym się różnią',
    'blog6.exc':   'Obie opcje pomagają się zmienić, ale działają inaczej. Wyjaśniam zasadniczą różnicę podejść i komu co bardziej odpowiada.',
    'blog7.title': 'Techniki uziemienia: jak się uspokoić, gdy emocje przytłaczają',
    'blog7.exc':   'Uziemienie to zestaw technik powrotu do «tu i teraz». Działają przy lęku, flashbackach, dysocjacji.',
    'blog8.title': 'Zaburzenia snu i psychika: jak przerwać błędne koło',
    'blog8.exc':   'Depresja zaburza sen, zły sen pogłębia depresję. CBT przy bezsenności (CBT-I): metoda, która naprawdę zmienia strukturę snu.',
    'blog9.title': 'Zniekształcenia poznawcze: 10 pułapek myślenia, które nas unieszczęśliwiają',
