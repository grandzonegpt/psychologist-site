(function() {
  ...
  const i18n = {
    ru: {
      ...
      email: 'Email',
      bookContinue: 'Далее',
      consentNote: 'Записываясь, ты соглашаешься с <a href="/privacy.html" target="_blank" rel="noopener">политикой конфиденциальности</a>.',
      emailInvalid: 'Кажется, в адресе ошибка. Проверь email: на него придёт ссылка на встречу.',
      emailMaybeTypo: 'Возможно, опечатка. Может, %s? Если адрес верный, нажми «Далее» ещё раз.',
      loading: 'Загрузка...',
